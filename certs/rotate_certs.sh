...
/usr/local/opt/openssl/bin/openssl req -new -x509 -days 3650 -key server.key -out server.pem -subj "/C=US/ST=Illinios/L=Chicago/O=cta-near-me/CN=cta-near-me" -sha256
